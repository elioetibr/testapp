...
requirements-snyk: ## Generate requirements-snyk.txt for Snyk dependency scanning
	...
	@uv export --format requirements-txt --group production > temp-requirements.txt
	@echo "# This file was autogenerated by uv via the following command:" > requirements-snyk.txt
	@echo "#    uv export --format requirements-txt --group production" >> requirements-snyk.txt
	@echo "#" >> requirements-snyk.txt
	@echo "# Purpose: This file is used by Snyk for dependency vulnerability scanning" >> requirements-snyk.txt
	@echo "# in GitHub Actions. It contains all production dependencies with exact versions" >> requirements-snyk.txt
	@echo "# and cryptographic hashes for security verification." >> requirements-snyk.txt
	@tail -n +3 temp-requirements.txt >> requirements-snyk.txt
