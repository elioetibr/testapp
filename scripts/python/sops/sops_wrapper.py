...
class SOPSWrapper:
    ...
    def _decrypt_to_temp(self, enc_file: Path) -> Optional[Path]:
    ...
    def find_files(self, pattern: str, base_dir: Optional[Path] = None) -> List[Path]:
    ...
    def encrypt_files(self, pattern: str = "*.dec.yaml", base_dir: Optional[Path] = None) -> int:
        """
    ...
    def decrypt_files(self, pattern: str = "*.enc.yaml", base_dir: Optional[Path] = None) -> int:
        """
